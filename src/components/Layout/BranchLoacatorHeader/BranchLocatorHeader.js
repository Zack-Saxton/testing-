      ...
      <AppBar id="MainHeaderWrap" position="static">
        <Toolbar className="branchLocatorHeaderToolBar">
          ...
          >
            ...
            <Accordion className="noShadow">
              <AccordionDetails className="menuHead">
                <Link data-testid="careersLinksUrl" href={`${ ServerURL }/careers/`}>Careers</Link>
              </AccordionDetails>
            </Accordion>
            <Accordion className="noShadow">
              <AccordionDetails className="menuHead">
                  <Link data-testid="checkMyLinks" href= {!loginToken.isLoggedIn ? "/customers/applyForLoan" : "/customers/resumeApplication" }>Resume application</Link>                
              </AccordionDetails>
            </Accordion>
            <Accordion className="noShadow">
              <AccordionDetails className="menuHead">
