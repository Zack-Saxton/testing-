								...
								>
									...
									<Grid item lg={8} md={8} xs={12}>
										<Paper
											...
											onClick={() => {
												setCitizenship("PermanentResident");
											}}
										>
											Permanent Resident
										</Paper>
									...
									<Grid item lg={8} md={8} xs={12}>
										<Paper
											...
											className={
												citizenship === "ForeignResident"
													? "activeBorder radioBlock "
													: "radioBlock "
											}
											onClick={() => {
												setCitizenship("ForeignResident");
											}}
										>
											Foreign Resident
										</Paper>
									...
									<h4
										className={
											citizenship === "ForeignResident" ? "showMsg" : "hideMsg"
										}
									>
									...
									<Grid item lg={8} md={8} xs={12} className="alignButton">
										<Button
											...
											disabled={
												citizenship === "" || citizenship === "ForeignResident"
													? true
													: false
											}
