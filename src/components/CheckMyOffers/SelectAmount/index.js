                ...
                <div className = "mainDiv">
                    <Box>
                        <Grid xs={12}  container justify="center" alignItems="center">
                                ...
                                <Paper className='card' justify="center" alignItems="center">
                                    ...
                                    <Grid xs={12} className="alignSlider" container justify="center" alignItems="center">
                                        <Grid xs={11} sm={10} md={8} lg={8} xl={8} justify="center" alignItems="center">
                                            <Typography variant="p" className="setGreenColor" align="center" onClick ={ (e) => { setOffercode(hasOffercode ? false : true ) }}>
                                            ...
                                            <Grid className="alignButton">
                                                <Button stylebutton='{"background": "#0F4EB3", "color":""}' onClick={handleRoute}>
                                                    Continue
                                                </Button>
                                            </Grid>
                                        ...
                                        <Grid className="alignTextInsideCard">
                                                 <Typography className="alignText" variant="p" align="center">
                            ...
                            <Grid xs={11} sm={10} md={10} lg={10} xl={10} className="alignSmallText" container justify="center" alignItems="center">
                                <Typography className="smallText" variant="p" align="center">
