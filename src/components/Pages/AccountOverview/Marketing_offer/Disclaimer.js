...
export default function Disclaimer(offerData){
    ...
    {
        "title" : "",
        "content" : 'You are prequalified for a new secured loan, refinancing your existing loan(s). Recording fees and other loan fees as well as the cost of any optional products you may elect to purchase and finance, where permitted, may be added to the amount financed, and your new loan may have a different interest rate and term. Current auto loan information (e.g., balance, term, rate, payment), annual reduction in loan payments, and available equity in your vehicle are estimated based on information in your credit file. Vehicle value is based on the National Automobile Dealers Association Used Car Guide for your state. Commercial vehicles are not eligible for this offer. When refinancing your auto loan, you may not have to make a payment on your current loan with us and other identified auto loan this month. However, the duration of time for which you will not have a payment due will vary based on the terms of your current loans and the date your new loan is funded. The offer is valid through the expiration date above. If you respond after the offer expiration date or do not meet the predetermined criteria, normal lending requirements apply.',
    }];
