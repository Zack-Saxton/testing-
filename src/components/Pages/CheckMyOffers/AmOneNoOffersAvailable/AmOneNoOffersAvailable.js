    ...
    <div>
      <Grid className={classes.blueBackGround}>
          ...
          <Paper className={classes.AmOnePaper}>
            ...
            <Grid className={classes.getMoreOptionGrid}>
              ...
              <Grid className={classes.checkMyOption}>
                <a rel="noreferrer" target="_blank" className="checkMyOffersLink" href="http://o1.qnsr.com/cgi/r?;n=203;c=1674838;s=30419;x=7936;f=202012171442020;u=j;z=TIMESTAMP">
                    <ButtonPrimary
                          id="checkMyOptions"
        ...
        <Grid className={classes.preFooterText}>
          <Typography className={classes.preFooterTypography}>
            * AmOne is a brand owned and operated by QuinStreet PL, Inc. 
            ...
            disclosures contained therein. Quinstreet and/or its partners determine
            the underwriting criteria necessary for approval for any financial product
            or service, and you should review Quinstreet and any of its partners’ terms 
            and conditions to determine which loan offer, if any, best suits your personal 
            financial situation. All rates, fees, and terms on the Quinstreet Website are 
            presented without guarantee from Mariner Finance, LLC (“Mariner”) and are subject 
            to change pursuant to Quinstreet or its partners’ discretion. Mariner cannot 
            guarantee that you will be approved for credit or that upon approval you will 
            qualify for the advertised rates, fees, or terms that were shown. Any offers or 
            information that may appear on the Quinstreet Website have not been reviewed 
            and/or approved by Mariner. Mariner will not provide any of your personal information
            to Quinstreet, even if you click the shown link to the Quinstreet Website. 
            Mariner may be compensated by Quinstreet if you click through to the Quinstreet 
            Website, fill out the relevant form(s), apply for, and receive a financial product 
            from one of Quinstreet’s partners.
          </Typography>
          <br/>
          <Typography className={classes.preFooterTypography}>
            ** Please review the terms and conditions presented on the 
            ...
            to the Quinstreet Website. Mariner is not responsible for any change 
            in your credit score or any related inquiries resulting from your 
            submission of personal information to the Quinstreet Website.
          </Typography>
        </Grid>
        </Grid>
      </Grid>
