                    ...
                    <Box>
                        <Grid xs={12}  container justify="center" alignItems="center">
                            ...
                            <Grid xs={12}  container justify="center" alignItems="center">
                                ...
                                <Grid xs={9} sm={6} md={5} lg={4} xl={4} className='alignButton paddingButton' container justify="center" alignItems="center">
                                    <Button stylebutton='{"background": "#FFFFFF", "color":"black", "fontSize": "1rem" }' >
                                        Finish by Phone
                                    </Button>
                                </Grid>
                                <Grid xs={9} sm={6} md={5} lg={4} xl={4} className='alignButton paddingButton' container justify="center" alignItems="center">
