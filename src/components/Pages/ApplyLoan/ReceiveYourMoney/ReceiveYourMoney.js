        ...
        <Grid item xs={12}>
          ...
          <Grid item xs={12}  fullWidth={true} direction="row">
              ...
              <div >
                  ...
                  <p style={{textAlign: "justify"}}><b>Thank you for submitting your verification information!</b><br />
                  You should receive an email regarding the funds by the end of the next business day provided that we require no additional information, in which case we will reach out to you.</p>
              </div>
                </Paper>
                </Grid>
          </TabPanel>
