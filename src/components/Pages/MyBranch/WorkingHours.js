...
export const upt_ca_M_W_TH_F = skipPastTime(ca_M_W_Th_F);
...
export const upt_ca_Tue = skipPastTime(ca_Tue);
...
export const upt_other_Fri = skipPastTime(Other_Fri);
...
export const updated_other_Tue = skipPastTime(other_Tue);